...
!{border: 0}https://i.ibb.co/WkQ1PJk/npp-8-4-7-x64-win10-docked.png(npp-8-4-7-x64-win10-docked)!
...
| *"default":default*      |  5.3.8                  |  8.6+          (all builds)    |
| *"api-v5.3.6-8":v5.3.6*  |  5.3.6/8                |  8.5.6 - 8.5.8 (all builds)    |
| *"api-v5.3.5-6":v5.3.5*  |  5.3.5/6                |  8.5.4 - 8.5.5 (all builds)    |
...
[v5.3.6]https://bitbucket.org/rdipardo/delphiplugintemplate/get/api-v5.3.6-8.zip
...
h3. Optional Scintilla Features (as of v5.3.2)[12]
...
fn12. "Scintilla 5.3.2 definitions":https://github.com/notepad-plus-plus/notepad-plus-plus/blob/fc61868cf2e317bfb7384502f80b6476fda6ddc8/scintilla/include/Scintilla.h
