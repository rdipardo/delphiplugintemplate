...
| *"default":default*      |  5.3.2/3                |  8.5+   (all builds)           |
...
h3. Dark Mode API (Notepad++ 8.4.1 and later)
...
h3. Optional Scintilla Features (as of v5.3.2)[9]
...
fn9. "Scintilla 5.2.3 definitions":https://github.com/notepad-plus-plus/notepad-plus-plus/blob/fc61868cf2e317bfb7384502f80b6476fda6ddc8/scintilla/include/Scintilla.h
